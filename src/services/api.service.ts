...
export class ApiService {
  ...
  protected post<T = any>(
    ...
    return ApiService.handleRequest(this.instance.post(url, data, options));
  }
  ...
  protected get<T = any>(
    ...
    return ApiService.handleRequest(this.instance.get(url, options));
  }
  ...
  protected put<T = any>(
    ...
    return ApiService.handleRequest(this.instance.put(url, data, options));
  }
  ...
  protected delete<T = any>(
    ...
    return ApiService.handleRequest(this.instance.delete(url, options));
  }
